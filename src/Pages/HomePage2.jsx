...
const HomePage2 = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 flex flex-col justify-start items-start">
      {/* Navigation Bar */}
      <div className="w-full px-6 md:px-16 lg:px-24 py-4 bg-white shadow-md sticky top-0 z-50 flex justify-between items-center">
